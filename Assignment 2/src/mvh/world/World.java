...
/**
 * Creates the visual representation of the World and adds walls, floors and the Symbols relative to the indices position
 *
...
/**
 * Displays the Stats and basic information of the Hero and Monster when encountered
 *
 * @return A detailed string representation of the game state.
 * */
